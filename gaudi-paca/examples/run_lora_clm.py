...
from peft import AdaLoraConfig, IA3Config, LoraConfig, PacaConfig, TaskType, get_peft_model, tuners
...
class FinetuneArguments:
    ...
    peft_type: str = field(
        ...
        metadata={
            ...
            "choices": ["lora", "dora", "moslora", "paca","ia3", "adalora"],
        },
    )
...
def main():
    ...
    if training_args.do_train or training_args.do_eval:
        ...
        elif finetune_args.peft_type == "dora":
            peft_config = LoraConfig(
                r=finetune_args.lora_rank,
                lora_alpha=finetune_args.lora_alpha,
                lora_dropout=finetune_args.lora_dropout,
        ...
        elif finetune_args.peft_type == "moslora":
            peft_config = LoraConfig(
                r=finetune_args.lora_rank,
                lora_alpha=finetune_args.lora_alpha,
                lora_dropout=finetune_args.lora_dropout,
        ...
        elif finetune_args.peft_type == "paca":
            peft_config = PacaConfig(
                r=finetune_args.lora_rank,
                paca_alpha=finetune_args.lora_alpha,
                target_modules=finetune_args.lora_target_modules,
                bias="none",
                task_type=TaskType.CAUSAL_LM,
            )
